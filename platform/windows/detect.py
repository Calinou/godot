...
def get_opts():
    ...
    return [
        ...
        ('target_win_version', 'Targeted Windows version, >= 0x0601 (Windows 7)',
         '0x0601'),
        ...
        ('msvc_version',
         'MSVC version to use. Ignored if VCINSTALLDIR is set in shell env.', None),
        BoolVariable(
            'use_mingw',
...
def configure_msvc(env, manual_msvc_config):
    ...
    if (env["target"] == "release"):
        ...
        env.AppendUnique(
            CPPDEFINES=['DEBUG_ENABLED', 'DEBUG_MEMORY_ENABLED', 'D3D_DEBUG_INFO'])
        env.Append(LINKFLAGS=['/SUBSYSTEM:CONSOLE'])
    ...
    env.AppendUnique(CPPDEFINES=[
        'WINDOWS_ENABLED', 'OPENGL_ENABLED', 'WASAPI_ENABLED', 'WINMIDI_ENABLED',
    ...
    LIBS = [
        ...
        'gdi32', 'IPHLPAPI', 'Shlwapi', 'wsock32', 'Ws2_32', 'shell32', 'advapi32',
        'dinput8', 'dxguid', 'imm32', 'bcrypt', 'Avrt'
    ]
...
def configure_mingw(env):
    ...
    env.Append(CPPDEFINES=[(
        'WINVER', env['target_win_version']), ('_WIN32_WINNT',
                                               env['target_win_version'])])
    env.Append(LIBS=[
        'mingw32', 'opengl32', 'dsound', 'ole32', 'd3d9', 'winmm', 'gdi32', 'iphlpapi',
        'shlwapi', 'wsock32', 'ws2_32', 'kernel32', 'oleaut32', 'dinput8', 'dxguid',
        'ksuser', 'imm32', 'bcrypt', 'avrt', 'uuid'
    ])
